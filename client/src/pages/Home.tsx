...
export default function Home() {
  ...
  function handleStart() {
    if (reverseMode) {
      ...
      sessionStorage.setItem("prompitect_initial_prompt", promptText);
      sessionStorage.setItem("prompitect_target_model", selectedModel);
      navigate("/scaffold");
    } else {
      navigate("/discovery");
    }
          ...
          <div className="w-full max-w-3xl space-y-8">
            ...
            <div className="text-center space-y-3">
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <span className="text-2xl font-semibold tracking-tight">Prompitect</span>
              </div>
